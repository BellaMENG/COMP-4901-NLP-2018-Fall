...
from keras.optimizers import Adam, adam, SGD, sgd
import numpy as np
...
def build_model(embedding_dim, hidden_size, drop, sequence_length, vocabulary_size, optimize):
    ...
    model.compile(loss='sparse_categorical_crossentropy', optimizer=optimize)
...
def main(opt):
    ...
    if opt.mode == "train":
        ...
        model = build_model(opt.embedding_dim, opt.hidden_size, opt.drop, sequence_length, vocabulary_size, opt.optimizer)
        print("Traning Model...")
